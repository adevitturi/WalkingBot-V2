...
## About
I think that my strongest motivation for building walking mechanisms began after discovering the marvelous [strandbeests by Theo Jansen][1].
Then after doing some research I found that there are many other derived mechanimsms with different step profiles.
The one that caught my attention the most was the [trotbot][2], so I based my design on it, adding just some small modifications to the linkage structure.
...
The hardware for this robot consists of:
 ...
 - 1x [ultrasound sensor][7]
 - 2x [dc motors with gearbox][8]
 - 1x [SG90 Servo 180 degrees][9]
...
[7]: https://www.amazon.com/UIOTEC-Operating-HC-SR04-P-Ultrasound-Ultrasonic/dp/B07DWWTT3F/ref=sr_1_8?dchild=1&keywords=ultrasound+arduino&qid=1611461527&sr=8-8 "Ultrasound sensor"
[8]: https://www.amazon.com/AutoEC-4pcs-Motor-Smart-Robot/dp/B00U4HP0SQ/ref=sr_1_39?dchild=1&keywords=arduino+dc+motor&qid=1611461562&sr=8-39
[9]: https://www.amazon.com/SunFounder-Digital-Helicopter-Airplane-Controls/dp/B01M5LIKLQ/ref=sr_1_18?dchild=1&keywords=tower+pro+sg90&qid=1611461723&sr=8-18 "Servo"
